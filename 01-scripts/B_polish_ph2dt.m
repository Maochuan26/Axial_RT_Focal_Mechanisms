...
% Update the filename below to match the current B output date:
load(fullfile(cfg.dataDir, 'A_ph2dt_past30days_combined_until_20260301.mat'))
...
save(fullfile(cfg.dataDir, 'B_ph2dt.mat'), 'Felix');